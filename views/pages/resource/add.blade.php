    ...
    <div class="col-lg-12">
      <form role="form" action="{{ route('resource.store') }}" method="post" >
        ...
        <div class="row mb-3 mt-3">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control @error('code') is-invalid @enderror" placeholder="Controller@Function" id="code" name="code" value="{{ old('code') }}">
            @error('code')
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <textarea class="form-control @error('description') is-invalid @enderror" id="description" rows="3" name="description">{{ old('name') }}</textarea>
          </div>
        </div>
