    ...
    <div class="col-lg-12">
      <form role="form" action="{{ route('role.store') }}" method="post" >
        ...
        <div class="form-group row mb-3">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control @error('display_name') is-invalid @enderror" id="display_name" name="display_name" placeholder="Nama Role" value="{{ old('display_name') }}" placeholder="Nama Role">
            @error('display_name')
          ...
          <ul id="" class="main_ul">
            ...
            <li id="">
              ...
              <ul id="" style="display: none" class="inner_ul">
                ...
                <li id="">
                  <input type="checkbox" id="menu[]" name="menu[]" value="{{ $child->id }}" /><span> {{ $child->display_name }} </span>
                </li>
                @endforeach
              </ul>
            </li>
